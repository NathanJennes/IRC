...
#define RPL_MYINFO(user)								(SERVER_SOURCE("004", user) + " " + Server::info().name() + " " + Server::info().version() + " " + Server::info().user_modes() + " " + Server::info().channel_modes() +  " " + Server::info().channel_modes_params())
...
#define RPL_NOTOPIC(user, channel)						(SERVER_SOURCE("331", user) + " " + (channel).name() + " :No topic set")
#define RPL_TOPIC(user, channel)						(SERVER_SOURCE("332", user) + " " + (channel).name() + " :" + (channel).topic())
#define RPL_SETTOPIC(user_that_modified, channel)		(":" + user_that_modified + " TOPIC " + (channel).name() + " :" + (channel).topic())
