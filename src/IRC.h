...
#define RPL_ISUPPORT(user, tokens)			(SERVER_SOURCE("005", user) + " " + tokens +" :are supported by this server")
...
#define ERR_NOSUCHSERVER(servername)					(SERVER_SOURCE("402", user) + " " + servername + " :No such server")
